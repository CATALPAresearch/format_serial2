 ...
 */
function format_serial2_upgrade_remove_numsections() {
    global $DB;
    ...
    $params = ['format1' => 'serial2', 'format2' => 'serial2', 'numsections' => 'numsections'];
    ...
    foreach ($needfixing as $courseid => $numsections) {
        format_serial2_upgrade_hide_extra_sections($courseid, $numsections);
    }

    $DB->delete_records('course_format_options', ['format' => 'serial2', 'sectionid' => 0, 'name' => 'numsections']);
}
 ...
 */
function format_serial2_upgrade_hide_extra_sections($courseid, $numsections) {
    global $DB;
