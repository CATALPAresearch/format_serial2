...
<template>
    <div id="dashboard-overview">
        ...
        <div v-for="section in stats" class="row col-12 mb-0">
            ...
            <div class="col-2 mb-1" style="border: solid #111 0pt;">
                ...
                <span v-if="section.longpage" class="mb-1"
                    style="display:block;position:relative;width:100%;height:15px;background-color:#eee;">
                    <span
                        :style="'position:absolute;background-color:'+getBarColor('longpage_completion', getRatio(section.longpage.complete, section.longpage.count))+';display:block;height:100%;width:'+ getRatio(section.longpage.complete, section.longpage.count, 100) +'%;'">
                    </span>
                    <span class="p-1 d-none d-md-block"
                        style="z-index:10;position:absolute;color:#333;font-size:0.7rem;vertical-align:middle;display:block;height:100%;">
                        {{ Math.round(getRatio(section.longpage.complete, section.longpage.count)) }}% gelesen
                    </span>
                </span>
                <span v-if="section.longpage == null">-</span>
            </div>
            ...
            <div v-if="!controlgroup" class="col-3 mb-1" style="border: solid #111 0pt;">
                ...
                <button class="btn btn-default" :disabled="sectionMinimumAchived(section.id) == false"
                    ...
                    data-toggle="modal" data-target="#refelctionModal" @click="setCurrentReflectionSection(section.id)">
