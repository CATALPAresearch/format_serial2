...
define([
    ...
    M.cfg.wwwroot + "/course/format/serial2/lib/build/moment-with-locales.min.js"
],
    function ($, Vue, moment) {
        ...
        require.config({
            enforceDefine: false,
            paths: {
                "moment226": [M.cfg.wwwroot + "/course/format/serial2/lib/build/moment-with-locales.min.js"],
            },
            shim: {
                "moment226": {
                    exports: 'moment'
                ...
                return new Vue({
                    ...
                    methods:{
                        ...
                        getLink: function(p, action){
                            return M.cfg.wwwroot + '/course/format/serial2/policy.php?policy='+p.id+'&version='+p.version+'&status='+action;
                        },
